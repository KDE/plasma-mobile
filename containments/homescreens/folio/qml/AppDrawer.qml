...
Item {
    ...
    Item {
        ...
        Item {
            id: swipeContainer
            anchors.topMargin: root.headerItem.searchField.height + Kirigami.Units.largeSpacing * 1.5
            anchors.bottomMargin: Math.max(root.bottomPadding - Kirigami.Units.gridUnit, 0)
            anchors.top: parent.top
            anchors.left: parent.left
            anchors.right: parent.right
            ...
            Item {
                ...
                AppDrawerAppGrid {
                    ...
                    isCurrentlyActivePage: folio.HomeScreenState.currentAppDrawerPage === 0

                    width: swipeContainer.width
                    height: swipeContainer.height
                    containerTopMargin: Math.round(Kirigami.Units.gridUnit * 2.5)
                ...
                AppDrawerCategoryGrid {
                    ...
                    isCurrentlyActivePage: folio.HomeScreenState.currentAppDrawerPage === 1
            ...
            layer.effect: OpacityMask {
                ...
                maskSource: Rectangle {
                    ...
                    // mask to mask out the category tabbar from the app grids
                    Rectangle {
