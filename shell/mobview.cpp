...
void MobView::screenOwnerChanged(int wasScreen, int isScreen, Plasma::Containment* containment)
{
...
void MobView::grabContainment()
{

    MobCorona *corona = qobject_cast<MobCorona*>(scene());
    if (!corona) {
        kDebug() << "no corona :(";
        return;
    }
