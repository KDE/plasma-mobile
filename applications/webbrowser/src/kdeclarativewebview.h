...
class QDeclarativeWebPage : public KWebPage {
    Q_OBJECT
public:
    explicit QDeclarativeWebPage(KDeclarativeWebView *parent);
    ~QDeclarativeWebPage();
protected:
...
class KDeclarativeWebView : public QDeclarativeItem {
    Q_OBJECT
    ...
    Q_PROPERTY(KDeclarativeWebSettings* settings READ settingsObject CONSTANT)
...
public:
    ...
    KDeclarativeWebSettings *settingsObject() const;
...
private Q_SLOTS:
    ...
    KDeclarativeWebView* createWindow(QWebPage::WebWindowType type);

private:
    void updateContentsSize();
    void init();
    virtual void componentComplete();
    Q_DISABLE_COPY(KDeclarativeWebView)
    KDeclarativeWebViewPrivate* d;
...
public:
    KDeclarativeWebViewAttached(QObject* parent)
        : QObject(parent)
    {
    }
...
class KDeclarativeWebSettings : public QObject {
    Q_OBJECT
...
QML_DECLARE_TYPE(KDeclarativeWebView)
QML_DECLARE_TYPE(KDeclarativeWebSettings)
QML_DECLARE_TYPEINFO(KDeclarativeWebView, QML_HAS_ATTACHED_PROPERTIES)
