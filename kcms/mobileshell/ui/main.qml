            ...
            FormCard.FormComboBoxDelegate {
                ...
                model: ListModel {
                    ...
                    Component.onCompleted: {
                        append({"name": statusBarScaleFactorDelegate.smallString, "value": 1.0});
                        append({"name": statusBarScaleFactorDelegate.normalString, "value": 1.5});
                        append({"name": statusBarScaleFactorDelegate.largeString, "value": 2.0});
